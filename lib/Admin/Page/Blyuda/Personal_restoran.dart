...
class _UserPageState extends State<PersonalRestoran> {
  ...
  Future<void> fetchUsers() async {
    ...
    final res = await http.get(
      ...
      headers: {
        ...
        'Authorization':
            'Bearer ${widget.token}', // Bu yerda global token ishlatiladi
      },
    );
  ...
  Future<void> addUser(Map<String, dynamic> userData) async {
    ...
    if (res.statusCode == 200 || res.statusCode == 201) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Foydalanuvchini qo‘shishda xatolik: ${res.statusCode}',
          ),
        ),
      );
    }
  ...
  Future<void> updateUser(String id, Map<String, dynamic> userData) async {
    ...
    if (res.statusCode == 200) {
      ...
      print(
        'Update user error: StatusCode=${res.statusCode}, Body=${res.body}',
      );
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Foydalanuvchini yangilashda xatolik: ${res.statusCode}',
          ),
        ),
      );
    }
  ...
  void _openUserModal({Map<String, dynamic>? editUser}) {
    ...
    String percentage =
        (editUser != null && editUser['percent'] != null)
